...
public class InvoiceEntryGenerator {
    ...
    public static InvoiceEntry getRandomEntry() {
        Long quantity = Long.valueOf(RandomNumberGenerator.generateRandomNumber(2));
        BigDecimal price = BigDecimal.valueOf(RandomNumberGenerator.generateRandomNumber(3));
        ...
        return InvoiceEntry.builder()
            .withId(getRandomId())
            .withDescription(RandomWordGenerator.generateRandomWord())
